...
void Theme::SetDarkTheme() {
	...
	colors[ImGuiCol_WindowBg]				= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_MenuBarBg]				= ImVec4{ 0.125f, 0.11f, 0.11f, 1.0f };

	// Title bar of the window when docked
	colors[ImGuiCol_TitleBg]			    = ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_TitleBgActive]			= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_TitleBgCollapsed]		= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	...
	// Tabs (Button which is used to grab and move with window out of the docking)
	colors[ImGuiCol_Tab]					= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_TabHovered]				= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_TabActive]				= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_TabUnfocused]			= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
	colors[ImGuiCol_TabUnfocusedActive]		= ImVec4{ 0.094f, 0.094f, 0.094f, 1.0f };
